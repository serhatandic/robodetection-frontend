	...
	return (
		...
		>
			<path
				...
				//d="M 10 10 H 900 V 900 H 900 L 90 10"
				...
				style={{
					...
					transform:
						analogLeftDirection.length > 0
							? `${createTransform(
									analogLeftDirection[0]
							  )} ${createTransform(analogLeftDirection[1])}`
							: '',
				}}
			/>
			<circle
				...
				style={{
					...
					transform:
						analogRightDirection.length > 0
							? `${createTransform(
									analogRightDirection[0]
							  )} ${createTransform(analogRightDirection[1])}`
							: '',
				}}
			/>
		</svg>
